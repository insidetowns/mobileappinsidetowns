...
public class SubCategoryAdapterSearch extends RecyclerView.Adapter<SubCategoryAdapterSearch.BooldSampleHolders> {
    ...
    public SubCategoryAdapterSearch(Context context, List<SubCategoryObject> itemList) {
...
//        holder.countryName.setText(itemList.get(position).getName());
            ...
            holder.desc.setText(itemList.get(position).getId());
            holder.type.setText(itemList.get(position).getQuantity());
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    editor.putString("Subcategory_Id", ""+holder.desc.getText());
                    editor.putString("type", ""+holder.type.getText().toString().trim());
                    //    editor.putString("Subcategory_Id", ""+holder.desc.getText());
                    editor.commit();
                    ...
                    Log.e("140819 "," "+holder.type.getText().toString().trim());
