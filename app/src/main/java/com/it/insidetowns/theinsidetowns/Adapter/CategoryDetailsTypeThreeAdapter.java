...
public class CategoryDetailsTypeThreeAdapter extends RecyclerView.Adapter<CategoryDetailsTypeThreeAdapter.BooldSampleHolders> {
    ...
    public CategoryDetailsTypeThreeAdapter(Context context, List<CategoryObjectTypeThree> itemList) {
    ...
    public BooldSampleHolders onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.category_details_row_three, null);
