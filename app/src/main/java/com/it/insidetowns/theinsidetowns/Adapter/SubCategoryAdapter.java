...
public class SubCategoryAdapter extends RecyclerView.Adapter<SubCategoryAdapter.BooldSampleHolders> {
    ...
    public SubCategoryAdapter(Context context, List<SubCategoryObject> itemList) {
