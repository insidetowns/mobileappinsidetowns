...
public class CategoryDetailsAdapter extends RecyclerView.Adapter<CategoryDetailsAdapter.BooldSampleHolders> {
    ...
    public CategoryDetailsAdapter(Context context, List<CategoryObjectNew> itemList) {
    ...
    public BooldSampleHolders onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.category_details_row, null);
...
//        holder.countryName.setText(itemList.get(position).getName());
            ...
            holder.countryName.setText(" " + itemList.get(position).getQuantity());
            holder.name.setText(itemList.get(position).getCity());
            holder.desc.setText(itemList.get(position).getTest());
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    editor.putString("Subcategory_Id", "" + holder.id.getText().toString());
