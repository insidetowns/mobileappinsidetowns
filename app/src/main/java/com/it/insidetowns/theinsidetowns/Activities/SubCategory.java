...
public class SubCategory extends AppCompatActivity {
    ...
    private void SubCategoriesApiCall() {
        ...
        final StringRequest reqQueue = new StringRequest(Request.Method.GET, ""+getResources().getString(R.string.AppURL)+"api/Common/SubCategories?CatID="+CatId, new com.android.volley.Response.Listener<String>() {
            @Override
                ...
                //    Log.e("110819 "," length "+jsonArray.length());
                    ...
                    if(jsonArray.length()>0) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            //     Log.e("030819 "," ss "+ss);
                            allItems.add(new SubCategoryObject("" + jsonArray.getJSONObject(i).getString("Subcategory_Id"), "" + "" + jsonArray.getJSONObject(i).getString("Subcat_Image"), "" + jsonArray.getJSONObject(i).getString("Subcat_name"), ""+jsonArray.getJSONObject(i).getString("subCatcount"), ""));


                        }

                        SubCategoryAdapter rcAdapter = new SubCategoryAdapter(SubCategory.this, allItems);
                        lLayout2 = new GridLayoutManager(SubCategory.this, 1);
                        rView2.setHasFixedSize(true);
                        rView2.setLayoutManager(lLayout2);
                        rView2.setAdapter(rcAdapter);
                   ...
                   //     Toast.makeText(SubCategory.this, ""+jsonObject1.getString("Message"), Toast.LENGTH_LONG).show();
                        BaseActivity b = new BaseActivity();
                        b.ShowAnimatedDialogAllMsg(SubCategory.this, "m1",""+jsonObject1.getString("Message"));
...
/*
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                if (volleyError instanceof NetworkError) {
                    ...
                    BaseActivity b = new BaseActivity();
                    b.ShowAnimatedDialogAllMsg(SubCategory.this, "m1",""+message);
                    ...
                    if (volleyError.networkResponse.statusCode == 500) {
                        ...
                        BaseActivity b = new BaseActivity();
                        b.ShowAnimatedDialogAll(SubCategory.this, "3");
                    } else {
                    ...
                    BaseActivity b = new BaseActivity();
                    b.ShowAnimatedDialogAll(SubCategory.this, "1");
                } else if (volleyError instanceof ParseError) {
                    //   message = "Parsing error! Please try again after some time!!";
                    BaseActivity b = new BaseActivity();
                    b.ShowAnimatedDialogAll(SubCategory.this, "4");
                    ...
                    BaseActivity b = new BaseActivity();
                    b.ShowAnimatedDialogAll(SubCategory.this, "8");
                }
            ...
            public byte[] getBody() throws AuthFailureError {
                try {
                  ...
                  //  Toast.makeText(SubCategory.this, "Some error occurred. Please try again", Toast.LENGTH_LONG).show();
                    BaseActivity b = new BaseActivity();
                    b.ShowAnimatedDialogAll(SubCategory.this, "6");
                }
